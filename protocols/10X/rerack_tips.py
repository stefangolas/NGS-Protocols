...
lmgr = LayoutManager('10X_GEX_LibraryPrep_Deck.lay')
tip_rack = layout_item(lmgr, Tip96, 'STF_L_0001')
tip_support_resource = layout_item(lmgr, Tip96, 'TipSupport_0001')

with HamiltonInterface(windowed=True) as ham_int:
    ham_int.initialize()

    ham_int.set_labware_property(tip_support_resource.layout_name(),'MlStarCore96TipRack', TipType.uL_300)
