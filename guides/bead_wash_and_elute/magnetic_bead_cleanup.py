...
def magnetic_bead_cleanup(simulating=True, device_simulation=True):
    ...
    with HamiltonInterface(simulating=simulating, windowed=windowed) as ham_int:
        ...
        # Transport plate from HSP_Pipette2 to HHS5
        print("Step 3: Transporting plate from HSP_Pipette2 to HHS5...")
        transport_resource(ham_int, MIDI_Pipette, HHS5_MIDI.resource,
                            resource_type=GrippedResource.MIDI, core_gripper=True)

        # Add QIAseq Beads to HHS5 position (Round 1)
        print("Step 4: Adding QIAseq Beads (Round 1)...")
        ...
        # Shake plate
        print("Step 5: Mixing on shaker (10 sec @ 1000 rpm)...")
        ...
        print("Step 9: Performing ethanol washes (Round 1)...")
        ...
        print("Step 12: Mixing elution on HHS5...")
        ...
        # Transport to magnet
        print("Step 13: Moving to magnet...")
        transport_resource(ham_int, HHS5_MIDI.resource, MIDI_OnMagnet,
                         resource_type=GrippedResource.MIDI, core_gripper=True)
        
        # Let beads settle
        print("Step 14: Settling beads (60 sec)...")
        settle_timer = start_timer(60)
        settle_timer.wait(skip=device_simulation)

        # Get fresh HSP plate from stack
        print("Step 15: Getting fresh HSP plate from stack...")
        ...
        print("Step 16: Removing eluted samples...")
        double_aspirate_supernatant_96(ham_int, tracked_tips_300uL, tip_support, num_samples,
